...
public class AESUtil {
    private final static String encodeRules="I wanna be the guy";
    /*
     * 加密
     * 1.构造密钥生成器
...
//        encodeRules="SWE Dashboard";
//        System.out.println("请输入要解密的内容（密文）:");
        content = AESUtil.AESEncode(content);
        System.out.println("根据输入的规则"+encodeRules+"解密后的明文是:"+AESUtil.AESDncode(content));
    }
